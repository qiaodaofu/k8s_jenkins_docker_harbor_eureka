pipeline {
    ...
    parameters {
		...
		choice(name: 'CHOICES', choices: [ '开发','测试','生产' ], description: '下拉列表')
    ...
    stages {
        ...
        stage('Deploy') {
            ...
            steps {
				...
				sh "kubectl delete -n ${params.K8S_NAMESPACE} ${params.K8S_NAMESPACE}.apps/${params.APP_NAME}-deployment || true"
